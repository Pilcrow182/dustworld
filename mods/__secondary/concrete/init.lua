...
minetest.register_node("concrete:concrete_drying", {
	...
	groups = {snappy=3,choppy=3,oddly_breakable_by_hand=3,cracky=3},
})
...
minetest.register_abm({
	...
	action = function(pos, node, active_object_count, active_object_count_wider)
		minetest.set_node(pos, {name = "concrete:concrete_drying"})
	end,
})
...
-- 	recipe = {"default:sand", "default:cobble"},
-- })

-- minetest.register_craft({
-- 	type = "shapeless",
-- 	output = "default:gravel 2",
-- 	recipe = {"default:desert_sand", "default:cobble"},
-- })
