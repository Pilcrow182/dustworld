...
minetest.register_tool("3d_armor:helmet_stone", {
	description = "Stone Helmet",
	inventory_image = "3d_armor_inv_helmet_stone.png",
	groups = {armor_head=7, armor_heal=2, armor_use=700},
	wear = 0,
})
...
minetest.register_tool("3d_armor:helmet_diamond", {
	...
	groups = {armor_head=15, armor_heal=15, armor_use=40},
	wear = 0,
})
...
minetest.register_tool("3d_armor:chestplate_stone", {
	description = "Stone Chestplate",
	inventory_image = "3d_armor_inv_chestplate_stone.png",
	groups = {armor_torso=12, armor_heal=2, armor_use=700},
	wear = 0,
})
...
minetest.register_tool("3d_armor:chestplate_diamond", {
	...
	groups = {armor_torso=25, armor_heal=15, armor_use=40},
	wear = 0,
})
...
minetest.register_tool("3d_armor:leggings_stone", {
	description = "Stone Leggings",
	inventory_image = "3d_armor_inv_leggings_stone.png",
	groups = {armor_legs=7, armor_heal=2, armor_use=700},
	wear = 0,
})
...
minetest.register_tool("3d_armor:leggings_diamond", {
	...
	groups = {armor_legs=20, armor_heal=15, armor_use=40},
	wear = 0,
})
...
minetest.register_tool("3d_armor:shield_stone", {
	description = "Stone Shield",
	inventory_image = "3d_armor_inv_shield_stone.png",
	groups = {armor_shield=12, armor_heal=2, armor_use=700},
	wear = 0,
})
...
minetest.register_tool("3d_armor:shield_mese", {
	description = "Mese Shield",
	inventory_image = "3d_armor_inv_shield_mese.png",
	groups = {armor_shield=25, armor_heal=15, armor_use=50},
	wear = 0,
})

minetest.register_tool("3d_armor:shield_diamond", {
	description = "Diamond Shield",
	inventory_image = "3d_armor_inv_shield_diamond.png",
	groups = {armor_shield=25, armor_heal=15, armor_use=40},
	wear = 0,
})
...
if minetest.get_modpath("3d_armor") ~= nil then
	minetest.register_tool("3d_armor:helmet_meoc", {
		description = "Meoc Helmet",
		inventory_image = "3d_armor_inv_helmet_meoc.png",
		groups = {armor_head=30, armor_heal=30, armor_use=25},
		wear = 0,
	})

	minetest.register_tool("3d_armor:chestplate_meoc", {
		description = "Meoc Chestplate",
		inventory_image = "3d_armor_inv_chestplate_meoc.png",
		groups = {armor_torso=50, armor_heal=30, armor_use=25},
		wear = 0,
	})

	minetest.register_tool("3d_armor:leggings_meoc", {
		description = "Meoc Leggings",
		inventory_image = "3d_armor_inv_leggings_meoc.png",
		groups = {armor_legs=40, armor_heal=30, armor_use=25},
		wear = 0,
	})

	minetest.register_tool("3d_armor:shield_meoc", {
		description = "Meoc Shield",
		inventory_image = "3d_armor_inv_shield_meoc.png",
		groups = {armor_shield=50, armor_heal=30, armor_use=25},
		wear = 0,
	})

	minetest.register_craft({
		output = "3d_armor:helmet_meoc",
		recipe = {
	...
	minetest.register_craft({
		output = "3d_armor:chestplate_meoc",
		recipe = {
			{"meoc:crystal", "", "meoc:crystal"},
			{"meoc:crystal", "meoc:crystal", "meoc:crystal"},
			{"meoc:crystal", "meoc:crystal", "meoc:crystal"},
