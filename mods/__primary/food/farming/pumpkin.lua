...
minetest.register_node("farming:pumpkin", {
	...
	on_punch = function(pos, node, puncher)
		...
		if tool and ( string.find(tool, "sword") or tool == "survivalist:shears" ) then
			minetest.set_node(pos, {name = "farming:pumpkin_face"})
			puncher:get_inventory():add_item("main", ItemStack("farming:pumpkin_seed "..math.random(2, 6)))
		end
	end
})
