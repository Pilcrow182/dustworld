...
minetest.register_node("farming:pumpkin", {
	...
	on_punch = function(pos, node, puncher)
		...
		if tool and tool == "default:sword_wood" or tool == "default:sword_stone" or tool == "default:sword_steel" or tool == "default:sword_mese" then
			...
			puncher:get_inventory():add_item("main", ItemStack("farming:pumpkin_seed 2"))
...
minetest.register_node("farming:big_pumpkin", {
	...
	after_place_node = function(pos, placer)
		...
		for dy=0,1 do
			...
			pos.x = pos.x+1
			pos.z = pos.z-2
			minetest.env:set_node(pos, {name="farming:big_pumpkin_side", param2=0})   --       <==
			pos.x = pos.x+1
			minetest.env:set_node(pos, {name="farming:big_pumpkin_corner", param2=0}) --       <==
			pos.z = pos.z+1
