...
if minetest.setting_getbool("enable_damage") then
	...
	hb.register_hudbar("breath", 0xFFFFFF, "Breath", { bar = "hudbars_bar_breath.png", icon = "hudbars_icon_breath.png" }, 20, 20, true)
end
...
local function custom_hud(player)
	if minetest.setting_getbool("enable_damage") then
		...
		hb.init_hudbar(player, "breath", math.min(breath * 2, 20), nil, hide_breath)
	end
end
...
local function update_hud(player)
	if minetest.setting_getbool("enable_damage") then
		...
		if breath == 11 and hb.settings.autohide_breath == true then
			...
			hb.change_hudbar(player, "breath", math.min(breath * 2, 20))
		end
