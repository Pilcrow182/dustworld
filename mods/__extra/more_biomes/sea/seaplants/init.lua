...
minetest.register_node("seaplants:kelpgreen", {
	...
	groups = {snappy=3, seaplants=1, sea=1, food=2},
...
--[[
minetest.register_craftitem("seaplants:kelpgreensalad", {
	description = "Kelp green salad",
	inventory_image = "seaplants_kelpgreen.png",
	on_use = minetest.item_eat(1)
})

minetest.register_craftitem("seaplants:kelpbrownsalad", {
	description = "Kelp brown salad",
	inventory_image = "seaplants_kelpbrown.png",
	on_use = minetest.item_eat(1)
})

minetest.register_craftitem("seaplants:seagrassgreensalad", {
	description = "Seagrass green salad",
	inventory_image = "seaplants_seagrassgreen.png",
	on_use = minetest.item_eat(1)
})

minetest.register_craftitem("seaplants:seagrassredsalad", {
	description = "Seagrass red salad",
	inventory_image = "seaplants_seagrassred.png",
	on_use = minetest.item_eat(1)
})
--]]
