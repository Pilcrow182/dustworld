...
abstract_ferns.grow_horsetail = function(pos)
	...
	if 	   horsetail_size == 1 then
		minetest.add_node({x=pos.x, y=pos.y+1, z=pos.z}, {name="ferns:horsetail_01"})
	elseif horsetail_size == 2 then
		minetest.add_node({x=pos.x, y=pos.y+1, z=pos.z}, {name="ferns:horsetail_02"})
	elseif horsetail_size == 3 then
		minetest.add_node({x=pos.x, y=pos.y+1, z=pos.z}, {name="ferns:horsetail_03"})
	elseif horsetail_size == 4 then
		minetest.add_node({x=pos.x, y=pos.y+1, z=pos.z}, {name="ferns:horsetail_04"})
	end
end
